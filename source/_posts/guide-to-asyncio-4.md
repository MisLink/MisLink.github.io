...
`asyncio.Queue` 为协程提供了一个先进先出的数据结构，类似于多线程中的 `queue.Queue`，多进程中的 `multiprocessing.Queue`：
...
EchoServer_::1_55307: received b'This is the message. It will be sent in parts.'
